    ...
    return (
        ...
        <g id="ocean">
          ...
          <linearGradient id="water_1_" gradientUnits="userSpaceOnUse" x1="500" y1="354" x2="500" y2="200.667">
            ...
            <stop offset="1"  style={{stopColor:"#b3dcdf"}}/>
          </linearGradient>
        ...
        <g id="train">
          ...
          <g id="car-layers">
            ...
            <g id="Text">
              <text transform="translate(377.037 230.025)" className="st8 st10" style={{fontSize:"21"}}>
                404
              </text>
              <text transform="translate(659.5 213.994)" className="st8 st10" style={{fontSize:"24"}}>
              Page not found.
              </text>
            </g>
            <g id="ladders">

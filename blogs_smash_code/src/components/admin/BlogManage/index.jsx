...
const BlogManage = (props) => {
    ...
    return (
        <>
            ...
            <div className="d-flex mb-3 justify-content-end align-items-center">  <Button variant="contained" color="primary" onClick={() => { setOpenFormModel(true); setSelected(undefined); }}>Add New +</Button></div>
            {blogsData?.length > 0 ?
                <RecordsTable
                    allBlogs={blogsData}

    ...
    const submitForm = (e) => {
        ...
        if (formData.name.trim() && formData.email.trim() && formData.message.trim()) {
            ...
            if (emRgx.test(formData.email)) {
                emailjs.sendForm('service_6wvrm9j', 'template_3agi9v8', e.target, 'user_gT75s8QwENPHn7STZsFUI')
                    .then((result) => {
                        setPopAlert({ open: true, type: "success", msg: "Thank you! for contacting us." });
                        setFormData({ name: "", email: "", message: "" });
                    }, (error) => {
                        setPopAlert({ open: true, type: "error", msg: "something went wrong! plz also check your internet connection." });
                    });
            } else {
                setPopAlert({ open: true, type: "info", msg: "Email address is not valid!" });
            }
        } else {
            setPopAlert({ open: true, type: "info", msg: "All input fields are required!" });
        }
    };
    return (
        <section>
            <div className="container-lg px-md-4 px-3">
                <div className="row">
                    <div className="mt-2 col-12 text-center">
                        <h1 className="mb-4">Talk to Us</h1>
                        <Typography variant="h6" align="center">
                            Let’s discuss your project. Feel free to send us your queries and details.
                        </Typography>
                        <br />
                    </div>
                </div>
                <div className="row form-container justify-content-center align-items-center">
                            ...
                            <g id="Image">
                                <g id="g14">
                                    <g id="g16">
                                        ...
                                        <g id="envelope">
                                            <g id="g304">
                                                <path id="path306" d="M249.266 298.798L351.208 218.764C357.652 213.705 366.657 213.705 373.102 218.764L475.045 298.798V432.924H249.266V298.798Z" fill="#1aaca2" />
                                            </g>
                                            ...
                                            <g id="g324">
                                                <path id="path326" d="M362.155 365.9L249.265 298.877V432.924L362.155 365.9Z" fill="#1aaca2" />
                                            </g>
                                            <g id="g328">
                                                <path id="path330" d="M362.156 365.9L475.045 298.877V432.924L362.156 365.9Z" fill="#1aaca2" />
                                            </g>
                                            <g id="g332">
                                                <path id="path334" d="M351.209 352.89L249.267 432.924H475.044L373.102 352.89C366.658 347.831 357.652 347.831 351.209 352.89Z" fill="#40e0d6" />
                                            </g>
                                        </g>
                                        <g id="g348">
                    ...
                    <div className="col-md-6 col-12 text-center">
                        <form onSubmit={(e) => submitForm(e)} className="contact-form">
                            <div className="form-group position-relative">
                                ...
                                <input type="text" name="name" id="formName" className="form-control form-control-lg thick" placeholder="Name" value={formData.name} onChange={(e) => { setFormData({ ...formData, [e.target.name]: e.target.value }) }} />
                            </div>
                            <div className="form-group position-relative">
                                <FaRegEnvelopeOpen className="contact-label-icon" />
                                <label htmlFor="formEmail" className="d-block">
                                </label>
                                <input type="email" name="email" id="formEmail" className="form-control form-control-lg thick" placeholder="E-mail" value={formData.email} onChange={(e) => { setFormData({ ...formData, [e.target.name]: e.target.value }) }} />
                            </div>
                            <div className="form-group message position-relative">
                                <textarea id="formMessage" name="message" className="form-control form-control-lg" rows="7" placeholder="Message" value={formData.message} onChange={(e) => { setFormData({ ...formData, [e.target.name]: e.target.value }) }}></textarea>
                            </div>
                            <div className="text-center">
                                <button type="submit" className="btn btn-primary" tabIndex="-1">Send a message</button>
                            </div>
                            <div className="mt-4">
                                <p><span className="text-pri">Note:</span> If you find any issue with our website, let us know about {" "} your  valuable feedback</p>
                            </div>
                        </form>
                    </div>
                </div>
            </div>
            <Snackbar open={popAlert.open} autoHideDuration={3000} onClose={closeNotification} anchorOrigin={{
                vertical: "bottom",
                horizontal: "right",
            }}>

...
const components = [
  ...
  { name: "Details/blogDetails", path: "/blog/:blogTittle/:blogID" },
  { name: "Details/category", path: "/category/:categoryTittle/:categoryID" },
    ...
    <>
      ...
      {props.location.pathname && props.history.location.pathname !== "/AdminDashboard" &&
        <div className="floating-chat-btn-wrapper">
          ...
          <a className="floating-chat-btn a-white whatstbtn" href="https://wa.me/923071991737" target="_blank"><WhatsAppIcon /></a>
        </div>
      }
